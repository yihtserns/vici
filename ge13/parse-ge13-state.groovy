...
class Constituent {
  ...
  String resultUrl() {
    'http://resultpru13.spr.gov.my/module/keputusan/paparan/5_KeputusanDUN.php?kod=' + id
  }
  ...
  static Constituent from(td) {
    ...
    String areaId = (td.a.@onclick =~ /windKeputusan\('5_KeputusanDUN.php', '(\d+)'\)/)[0][1]
